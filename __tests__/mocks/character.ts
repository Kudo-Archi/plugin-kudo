import { Character, stringToUuid } from "@elizaos/core";
import { kudoPlugin } from "../../src";
import { bootstrapPlugin } from "@elizaos/plugin-bootstrap";
import { evmPlugin } from "@elizaos/plugin-evm";
import { CovenantStatus } from "src/types";

export const TEST_USER = {
  id: stringToUuid("Test-User"),
  name: "TEST USER",
  username: "test-user",
};
...
export const MOCK_CHARACTER: Character = {
  name: "degenspartanai",
  clients: [],
  plugins: [kudoPlugin, bootstrapPlugin, evmPlugin],
  settings: {
    voice: {
...
export const getMockCovenantData = ({
  covenantPromise = "",
  promiseDetail = "",
}: {
  ...
  return [
    {
      agentWallet: "0x701Cc45bEbD51c02A79074c25d0485cdeEFE16aC",
      status: CovenantStatus.IN_PROGRESS,
      nftType: "LOAN",
      ask: "Pay 100 USDC to 0x701Cc45bEbD51c02A79074c25d0485cdeEFE16aC",
      covenantPromise,
      promiseDetail,
      promiseSettlementData: "mock settlement data",
      askSettlementData: "mock ask settlement data",
